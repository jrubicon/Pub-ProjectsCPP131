...
void	TestAdd(Result& result)
{
	//************************************************************************************
	//	LOCAL DATA
	AuthorizationVector	actualVector; //creates a vector named actualVector?

	AuthorizationVector	expectedVector; //creates a vector named expectedVector?

	GateControl			gateControl; //gatecontrol class object

	bool				good; //bool variable declared

	bool				success; //bool variable declared
	...
	//push authorization object with set vars to vector
	success = gateControl.AddAuthorization(111, "Smith, John", "0800", "1700");
